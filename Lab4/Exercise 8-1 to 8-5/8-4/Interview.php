...
<td><input type="text" class="form-control" required placeholder="Communication Abilities"
name="cabilities"/>
</td>
</tr>
<tr>
<td><label>Professional Appearance:</label></td>
<td><input type="text" class="form-control" required placeholder="Professional Appearance" name="papp"/>
</td>
</tr>
<tr>
<td><label>Computer Skills:</label></td>
<td><input type="text" class="form-control" required placeholder="Computer Skills" name="Compskill"/>
</td>
</tr>
<tr>
...
<td><input type="text" class="form-control" required placeholder="Interviewer’s Comment" name="icomm"/>
</td>
</tr>
...
Thank u for submitting the details.The information has been saved.Click
<a href="demo.php">here </a> to check thedetails
</form>
</div>
</body>
</html>
