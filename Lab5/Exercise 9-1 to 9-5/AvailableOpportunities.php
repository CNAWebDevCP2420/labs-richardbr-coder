...
<body>
    ...
    $errors = 0;
    // connecting and storing in $DBConnect
    ...
    // for all of the assigned opportunities that have been selected by this intern
    ...
    // the assigned opportunities that have already been approved
    ...
    $Opportunities = array();
    // create a sql string, $SQLstring, that gets all of the opportunties
